...
// Form elements
var userForm = document.getElementById("gameForm");
...
if (userForm) {
  userForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var formData, data, res, user, gameCode, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            ...
            if (res.data.status === "success") {
              ...
              if (res.data.data.user.host === true) {
                gameCode = res.data.data.hosted.code;
                (0, _alert.showAlert)("success", "Your hosted Game code is ".concat(gameCode));
              }
            }
            _context.n = 4;
            break;
          case 3:
            _context.p = 3;
            _t = _context.v;
            console.error("Error joining/hosting:", _t);
          case 4:
            return _context.a(2);
        }
      }, _callee, null, [[1, 3]]);
...
},{"axios":"../node_modules/axios/index.js","./alert":"alert.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","user.js"], null)
